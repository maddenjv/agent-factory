...
re-run the suite on the merged result, `git push origin main`. Note what you checked, close your issue.
...
Non-blocking observations go into your closing note or as separate low-priority issues, not rework.
